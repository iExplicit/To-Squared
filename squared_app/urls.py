...
from squared_app import views, views_api, auth_views
...
urlpatterns = [
    ...
    # API Route for Ajax
    url(r'^api/todos/(?P<pk>[0-9]+)$', views_api.SquaredItemView.as_view(), name='api_todo_item'),
    url(r'^api/todos$', views_api.SquaredListView.as_view(), name='api_todo_list'),
